...
上記の方法で並進速度と角速度が得られたので，スラロームの走行自体は可能なのですが，速度だけでなく位置のフィードバック制御を行うためには，各時刻の $x(t),y(t)$ が必要となります．

事前設計のときと同様に，速度が関数の形で入手できているので，ルンゲ=クッタ法によって数値積分することによって各時刻の位置をえることができます．
